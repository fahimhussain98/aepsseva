...
public class PaySprintActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        window.setStatusBarColor(ContextCompat.getColor(PaySprintActivity.this, R.color.black));
        //////CHANGE COLOR OF STATUS BAR///////////////
    ...
    private void doAepsTransaction() {
        ...
        Call<JsonObject> call = ApiController.getInstance().getApi().doAepsTransaction(ApiController.Auth_key, userId, aadharNo, selectedBankIIN, amount,
                selectedTransactionType, pidData, lat, longi, custMobile, selectedBankName, deviceId, deviceInfo);
                        ...
                        if (responseCode.equalsIgnoreCase("TXN")) {
                            ...
                            for (int i = 0; i < transactionArray.length(); i++) {
                                ...
                                if (transactionType.equalsIgnoreCase("MINI STATEMENT")) {
                                    ...
                                    startActivity(intent);
                                   // finish();   // comment by shuaib by seeing latest maple pay
                                    ...
                                    startActivity(intent);
                                   // finish();  //  after seeing latest maple pay
                                }
