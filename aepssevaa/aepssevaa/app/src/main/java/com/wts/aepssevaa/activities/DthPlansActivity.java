...
import com.wts.aepssevaa.adapters.DthPlansAdapter;
import com.wts.aepssevaa.models.DthPlansModel;
...
public class DthPlansActivity extends AppCompatActivity {
    ...
    private void getPlans(String operator) {
        ...
        pDialog.show();
        Call<JsonObject> call = ApiController.getInstance().getApi().getDthMplan(userId,deviceId,deviceInfo,operator);
