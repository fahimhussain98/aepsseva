...
public class RechargeStatusActivity extends AppCompatActivity {
    ...
    String responseNumber, responseAmount, responseStatus, responseTransactionId,responseLiveId, responseOperator;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        responseLiveId=getIntent().getStringExtra("responseLiveId");
        ...
        tvLiveId.setText("LiveId : "+responseLiveId);
