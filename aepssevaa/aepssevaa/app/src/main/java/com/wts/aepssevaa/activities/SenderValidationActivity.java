...
public class SenderValidationActivity extends AppCompatActivity {
   ...
   // String selectedTxtMode = "Select Mode";
    String selectedTxtMode = "IMPS";
    String mobileNumber;
    public static String senderMobileNumber, sendername,senderId,remitterId, availablelimit, totalLimit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HintSpinner<String> hintSpinner = new HintSpinner<>(
                spinner,
                new HintAdapter<String>(SenderValidationActivity.this, "Select Mode", Arrays.asList(txtModeList)),
    ...
    private void isSenderValidate() {
        ...
        Call<JsonObject> call= ApiController.getInstance().getApi().isUserValidate(ApiController.Auth_key,deviceId,deviceInfo,userid,mobileNumber);
