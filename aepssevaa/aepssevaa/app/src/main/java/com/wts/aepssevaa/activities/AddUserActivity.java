...
public class AddUserActivity extends AppCompatActivity {
    ...
    TextView tvTitle;
    ImageView imgBack;
    String userType, userId,schemeUserType;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (userType.equalsIgnoreCase("ZBP")) {
    ...
    private void checkAddUser() {
        if (checkInputs()) {
            ...
            call = ApiController.getInstance().getApi().addUser(ApiController.Auth_key,userId,deviceId,deviceInfo,mobile,password,ownerName,schemeUserType,
    ...
    private void getState() {
        ...
        Call<JsonObject> call = ApiController.getInstance().getApi().getState(ApiController.Auth_key,userId,deviceId,deviceInfo);
    ...
    private void getCity() {
        ...
        Call<JsonObject> call = ApiController.getInstance().getApi().getCity(ApiController.Auth_key,userId,deviceId,deviceInfo,selectedStateId);
        call.enqueue(new Callback<JsonObject>() {
            @Override
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                if (response.isSuccessful()) {
    ...
    private void getScheme() {
        ...
        Call<JsonObject> call = ApiController.getInstance().getApi().getScheme(ApiController.Auth_key,userId,deviceId,deviceInfo,"ADDUSER",schemeUserType,"0");
        call.enqueue(new Callback<JsonObject>() {
            @Override
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                if (response.isSuccessful()) {
