...
public class PaysprintRecipientAdapter extends RecyclerView.Adapter<PaysprintRecipientAdapter.Viewholder> {
    ...
    public PaysprintRecipientAdapter(Context context, Activity activity, ArrayList<RecipientModel> recipientModelArrayList,
    ...
    public void onBindViewHolder(@NonNull final Viewholder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.btnPay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // etTpin.setVisibility(View.VISIBLE);  //  added by shuaib because tpin
                ...
                btnProceed.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (!TextUtils.isEmpty(etAmount.getText())) {
                            ...
                            //  payBenificary(recipientId, amount, bankAccountNumber, bankName, ifsc, recipientName,benificaryMobileNumber);  // because bene Mobile num get hi nhi hota paysprint dmt me
                            payBenificary(recipientId, amount, bankAccountNumber, bankName, ifsc, recipientName, PaysprintSenderValidationActivity.senderMobileNumber);
                            //  checkTpin(tpin, amount, recipientId, bankAccountNumber, bankName, ifsc, recipientName, PaysprintSenderValidationActivity.senderMobileNumber);
...
//            beneMobileNo = arrayList.get(position).getBeneMobileNo();
    ...
    private void payBenificary(String recipientId, final String amount, String bankAccountNumber, final String bankName, final String ifsc,
        ...
        if (PaysprintSenderValidationActivity.title.equalsIgnoreCase("Money Transfer")) {
            call = ApiController.getInstance().getApi().payBeneficiary(ApiController.Auth_key, userId, deviceId, deviceInfo, amount, recipientId, "NA",
                    PaysprintSenderValidationActivity.sendername, PaysprintSenderValidationActivity.senderMobileNumber, bankAccountNumber, benificaryName, bankName, ifsc,
                    beneMobileNumber, "IMPS", "NA");
        } else if (PaysprintSenderValidationActivity.title.equalsIgnoreCase("Money Transfer2")){
//            call = ApiController.getInstance().getApi().payBeneficiary2(ApiController.Auth_key, userId, deviceId, deviceInfo, amount, recipientId, "NA",
//                    PaysprintSenderValidationActivity.sendername, PaysprintSenderValidationActivity.senderMobileNumber, bankAccountNumber, benificaryName, bankName, ifsc,
//                    beneMobileNumber, "ifs", "NA");
        }
        else
        {
            call = ApiController.getInstance().getApi().payBeneficiary3(ApiController.Auth_key, userId, deviceId, deviceInfo, amount, recipientId, "NA",
                    PaysprintSenderValidationActivity.sendername, PaysprintSenderValidationActivity.senderMobileNumber, bankAccountNumber, benificaryName, bankName, ifsc,
                    beneMobileNumber, "IMPS", PaysprintSenderValidationActivity.lat, PaysprintSenderValidationActivity.longi);
        }
...
//                SenderValidationActivity.senderMobileNumber,"ifs","NA");
    ...
    private void payViaUpi(String recipientId, String amount, String upiId, String benificaryName, String benificaryMobileNumber) {
        ...
        Call<JsonObject> call = ApiController.getInstance().getApi().payUpi(ApiController.Auth_key, userId, deviceId, deviceInfo, amount, recipientId,
                PaysprintNewMoneyTransferActivity.senderName, PaysprintNewMoneyTransferActivity.senderMobileNumber, upiId, benificaryName, benificaryMobileNumber,
                "UPI", PaysprintSenderValidationActivity.lat, PaysprintSenderValidationActivity.longi);
    ...
    private void deleteBene(String recipientId, int position) {
        ...
        if (PaysprintSenderValidationActivity.title.equalsIgnoreCase("Money Transfer")) {
            call = ApiController.getInstance().getApi().deleteBeneficiary(ApiController.Auth_key, deviceId, deviceInfo, userId, recipientId, mobileNumber, PaysprintSenderValidationActivity.senderId);

        } else if (PaysprintSenderValidationActivity.title.equalsIgnoreCase("Money Transfer2")){
            //  call = ApiController.getInstance().getApi().deleteBeneficiary2(ApiController.Auth_key, deviceId, deviceInfo, userId, recipientId, mobileNumber, PaysprintSenderValidationActivity.senderId);

        }
        else
        {
            call = ApiController.getInstance().getApi().deleteBeneficiary3(ApiController.Auth_key, deviceId, deviceInfo, userId, recipientId, mobileNumber);
        }

        //  Call<JsonObject> call = RetrofitClient.getInstance().getApi().deleteBeneficiary(AUTH_KEY, deviceId, deviceInfo, userId, recipientId, mobileNumber, SenderValidationActivity.senderId);
        call.enqueue(new Callback<JsonObject>() {
            @Override
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                if (response.isSuccessful()) {
