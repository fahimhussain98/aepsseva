...
public class EkoAepsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eko_aeps);
        ...
        window.setStatusBarColor(ContextCompat.getColor(EkoAepsActivity.this, R.color.testcolornew));
        //////CHANGE COLOR OF STATUS BAR///////////////

        //////////////////////////////////////////////////////////////////

        sharedPreferences = PreferenceManager.getDefaultSharedPreferences(EkoAepsActivity.this);
...
//        tvBalance.setText("₹ " + balance);
        ...
        activity = EkoAepsActivity.this;

        etMobile.setText(mobileNo);
        //////////////////////////////////////////////////////////////////

        mFusedLocationClient = LocationServices.getFusedLocationProviderClient(EkoAepsActivity.this);
        getBankList();
    ...
    private void getBankList() {
        ProgressDialog progressDialog = new ProgressDialog(EkoAepsActivity.this);
        progressDialog.setMessage("Please wait...");
        progressDialog.setCancelable(false);
        progressDialog.show();

        Call<JsonObject> call = ApiController.getInstance().getApi().getBankForEkoAeps(ApiController.Auth_key, userId, deviceId, deviceInfo);
                    ...
                    try {
                        ...
                        if (responseCode.equalsIgnoreCase("TXN")) {
                            ...
                            for (int i = 0; i < transactionArray.length(); i++) {
                                ...
                                String bankIIN = transactionObject.getString("BankId");
                            ...
                            tvBankName.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    SpinnerDialog bankDialog = new SpinnerDialog(EkoAepsActivity.this, bankNameArrayList, "Select Bank", R.style.DialogAnimations_SmileWindow, "Close  ");// With 	Animation
                            ...
                            progressDialog.dismiss();
                            new androidx.appcompat.app.AlertDialog.Builder(EkoAepsActivity.this)
                                    .setCancelable(false)
    ...
    private void showMessageDialog(String message) {
        final AlertDialog messageDialog = new AlertDialog.Builder(EkoAepsActivity.this).create();
        final LayoutInflater inflater = LayoutInflater.from(EkoAepsActivity.this);
    ...
    private void getLastLocation() {
        if (checkPermissions()) {
            if (isLocationEnabled()) {
                ...
                Toast.makeText(EkoAepsActivity.this, "Turn on location", Toast.LENGTH_LONG).show();
    ...
    private boolean checkPermissions() {
        return ActivityCompat.checkSelfPermission(EkoAepsActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) == PackageManager.PERMISSION_GRANTED &&
                ActivityCompat.checkSelfPermission(EkoAepsActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED;
    }

    private void requestPermissions() {
        ActivityCompat.requestPermissions(EkoAepsActivity.this,
    ...
    private void doAepsTransaction() {
        ...
        // below added by shuaib beacuase sudheer ne kha amount 0 do in case balance equriry and mini statement
        if(selectedTransactionType.equalsIgnoreCase("be") || selectedTransactionType.equalsIgnoreCase("ms") ){
        ...
        Call<JsonObject> call = ApiController.getInstance().getApi().doEkoAepsTransaction(ApiController.Auth_key, userId, aadharNo, selectedBankIIN, amount,
                        ...
                        if (responseCode.equalsIgnoreCase("TXN")) {
                            ...
                            for (int i = 0; i < transactionArray.length(); i++) {
                                ...
                                if (transactionType.equalsIgnoreCase("MINI STATEMENT")) {
                                    ...
                                    Intent intent = new Intent(EkoAepsActivity.this, MiniStatementPaySprintActivity.class);
                                    ...
                                    String accountBalance = transactionObject.getString("accountBalance");
                                    Intent intent = new Intent(EkoAepsActivity.this, AepsTransactionActivity.class);
                                    intent.putExtra("transactionType", transactionType);
                                    intent.putExtra("bankName", bankName);
                                    intent.putExtra("responseMobileNumber", responseMobileNumber);
                                    intent.putExtra("responseAadharNumber", responseAadharNumber);
