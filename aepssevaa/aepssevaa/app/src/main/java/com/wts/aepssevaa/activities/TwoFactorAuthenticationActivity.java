    ...
    private void doAepsAuthentication() {
        ...
        if(title.equalsIgnoreCase("TwoFactorAuth")){
            if(appId.equalsIgnoreCase("11")){
                ...
                call = ApiController.getInstance().getApi().twoFactorAuthenticationInstantPay(ApiController.Auth_key,userId,deviceId,deviceInfo,aadharNo,custMobile,pidData,
                        lat,longi,appId);
            }
            else {

                call = ApiController.getInstance().getApi().twoFactorAuthentication(ApiController.Auth_key,userId,deviceId,deviceInfo,aadharNo,custMobile,pidData,
                        lat,longi);
            }
            ...
            call = ApiController.getInstance().getApi().twoFactorOnboard(ApiController.Auth_key,userId,deviceId,deviceInfo,aadharNo,custMobile,pidData,
                    lat,longi);
